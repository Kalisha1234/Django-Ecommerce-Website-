...
urlpatterns = [
    ...
    path("registration/", views.CustomerRegistrationView.as_view(), name="customerregistraton"),
...
admin.site.site_header ="Neel Diary Products"
admin.site.site_title = "Neel Diary Products"
